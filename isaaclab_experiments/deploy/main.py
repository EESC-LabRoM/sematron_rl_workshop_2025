...
from isaaclab_experiments.deploy.unitree import AnymalFlatTerrainPolicy
...
class Anymal_runner(object):
    def __init__(self, physics_dt, render_dt) -> None:
        ...
        print("Loading ANYmal robot")
        self._anymal = AnymalFlatTerrainPolicy(
            prim_path="/World/Anymal",
            name="Anymal",
            usd_path=assets_root_path+"/Isaac/Robots/Unitree/Go1/go1.usd",
            
            #r"C:\Users\judcn\OneDrive\Documentos\repositories\rl-isaaclab\go1\go1_description.usd",
            position=np.array([0, 0, 0.5]),
        )

        self._base_command = np.array([1.0, 0, 0])
    ...
    def on_physics_step(self, step_size) -> None:
        ...
        if self.first_step:
            ...
            # print("Command is: ", self._base_command)
            self._anymal.forward(dt=step_size, command=self._base_command)
